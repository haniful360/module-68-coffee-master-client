...
const UpdateCoffee = () => {
    ...
    return (
        <div className='bg-[#F4F3F0] px-4 md:px-28 py-16'>
            <h2 className='coffee-title text-center'>Update Coffee</h2>
            ...
            <form onSubmit={handleUpdateCoffee}>
                ...
                <div className="md:flex gap-6">
                    ...
                    <div className="form-control md:w-1/2">
                        ...
                        <input type="text" defaultValue={chef} placeholder="Chef" name='chef' className="input input-bordered w-full" />
                    </div>
                ...
                <input type="submit" value="Update Coffee" className='btn btn-block bg-[#D2B48C] text-white text-capitalize mt-6' />
            </form>
        </div>
    );
};
